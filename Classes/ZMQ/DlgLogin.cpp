...
DlgLoginMediator::DlgLoginMediator()
{
	...
	ADD_PACK_LISTENER(OnPackage,this,SocketCMDConst::SMSG_LOGIN_GETROLELIST,DlgLoginMediator)
	ADD_PACK_LISTENER(OnPackage,this,SocketCMDConst::SMSG_LOGIN_CREATEROLER,DlgLoginMediator)
	ADD_PACK_LISTENER(OnPackage,this,SocketCMDConst::SMSG_LOGIN_DELETEROLER,DlgLoginMediator)
}
...
void DlgLogin::joinBtnCallBack( CCObject* pSender )
{
	...
	login.set_version("123");
	login.SerializeToString(&strDat);
	SEND_PACK(SocketCMDConst::CMSG_LOGIN_GETROLELIST,strDat)
...
void DlgLogin::sureBtnCallBack( CCObject* pSender )
{
	...
	LayerManager::createAllLayer(runScene);
